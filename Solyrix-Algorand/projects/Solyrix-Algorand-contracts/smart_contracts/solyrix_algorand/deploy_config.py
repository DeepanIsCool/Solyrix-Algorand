...
def deploy() -> None:
    from smart_contracts.artifacts.solyrix_algorand.solyrix_algorand_client import (
        HelloArgs,
        SolyrixAlgorandFactory,
    )
    ...
    factory = algorand.client.get_typed_app_factory(
        SolyrixAlgorandFactory, default_sender=deployer_.address
    )
