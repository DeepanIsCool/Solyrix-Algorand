...
class ContextRegistryBareCallCreateParams(algokit_utils.AppClientBareCallCreateParams):
    """Parameters for creating ContextRegistry contract with bare calls"""
    on_complete: typing.Literal[OnComplete.NoOpOC] | None = None

    def to_algokit_utils_params(self) -> algokit_utils.AppClientBareCallCreateParams:
        return algokit_utils.AppClientBareCallCreateParams(**self.__dict__)

class ContextRegistryFactory(algokit_utils.TypedAppFactoryProtocol[ContextRegistryBareCallCreateParams, None, None]):
    """Factory for deploying and managing ContextRegistryClient smart contracts"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = ContextRegistryFactoryParams(self.app_factory)
        self.create_transaction = ContextRegistryFactoryCreateTransaction(self.app_factory)
        self.send = ContextRegistryFactorySend(self.app_factory)
    ...
    def deploy(
        ...
        *,
        ...
        create_params: ContextRegistryBareCallCreateParams | None = None,
        ...
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
        send_params: algokit_utils.SendParams | None = None,
    ) -> tuple[ContextRegistryClient, algokit_utils.AppFactoryDeployResult]:
        ...
        return ContextRegistryClient(deploy_response[0]), deploy_response[1]
...
class ContextRegistryFactoryParams:
    """Parameters for creating transactions for ContextRegistry contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ContextRegistryFactoryCreateParams(app_factory)
        self.update = ContextRegistryFactoryUpdateParams(app_factory)
        self.delete = ContextRegistryFactoryDeleteParams(app_factory)

class ContextRegistryFactoryCreateParams:
    """Parameters for 'create' operations of ContextRegistry contract"""
    ...
    def create_context(
        ...
        *,
        ...
        """Creates a new instance using the create_context(string,string,uint64)string ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
    ...
    def get_context_price(
        ...
        *,
        ...
        """Creates a new instance using the get_context_price(string)uint64 ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
    ...
    def purchase_context(
        ...
        *,
        ...
        """Creates a new instance using the purchase_context(string)string ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
...
class ContextRegistryFactoryUpdateParams:
    """Parameters for 'update' operations of ContextRegistry contract"""
...
class ContextRegistryFactoryDeleteParams:
    """Parameters for 'delete' operations of ContextRegistry contract"""
...
class ContextRegistryFactoryCreateTransaction:
    """Create transactions for ContextRegistry contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ContextRegistryFactoryCreateTransactionCreate(app_factory)


class ContextRegistryFactoryCreateTransactionCreate:
    """Create new instances of ContextRegistry contract"""
...
class ContextRegistryFactorySend:
    """Send calls to ContextRegistry contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = ContextRegistryFactorySendCreate(app_factory)


class ContextRegistryFactorySendCreate:
    """Send create calls to ContextRegistry contract"""
    ...
    def bare(
        ...
        *,
        ...
        send_params: algokit_utils.SendParams | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
    ) -> tuple[ContextRegistryClient, algokit_utils.SendAppCreateTransactionResult]:
        """Creates a new instance using a bare call"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        ...
        return ContextRegistryClient(result[0]), result[1]
